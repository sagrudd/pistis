...
Protocol specifications, canonical encodings, state machines, schemas, and
conformance vectors belong here. Protocol changes require an accepted ADR.
...
- [Exact-action approval v2](action-approval.md)
